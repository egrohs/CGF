...
class Meupanel extends Canvas
{
	...
	public void paint(Graphics g)
	{
		...
		{
			g.drawImage(Toolkit.getDefaultToolkit().getImage("e:\\Escova\\Cartas\\versoh.jpg"),i+650,i+350,this);
		}
		...
		{
			g.drawImage(Toolkit.getDefaultToolkit().getImage("e:\\Escova\\Cartas\\verso.jpg"),i*75+(800-75*j.getPc().getMao().size())/2,30,this);
		}
		for(int i=0;i<j.getPc().getMonte().size();i++)//poe a monte do pc
		{
			g.drawImage(Toolkit.getDefaultToolkit().getImage("e:\\Escova\\Cartas\\versoh.jpg"),i+30,i+30,this);
		}
	}
