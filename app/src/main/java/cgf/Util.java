...
public class Util {
	...
	//TODO este metodo esta deslocado nessa classe
	public static Zona getZonaRecursivo(Zona inicial, String nome) {
		if (inicial != null && nome != null && !nome.equals("")) {
			if (nome.equals(inicial.getName())) {
				return inicial;
			}
			for (Component c : inicial.getComponents()) {
				Zona found = getZonaRecursivo((Zona) c, nome);
				if (found != null)
					return found;
			}
		}
